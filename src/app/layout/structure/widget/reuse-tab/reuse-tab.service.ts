...
import { ActivatedRoute, ActivatedRouteSnapshot, NavigationEnd, NavigationStart, Router, ROUTER_CONFIGURATION, ExtraOptions } from '@angular/router';
import { ReuseComponentRef, ReuseTabCached, ReuseTabNotify, ReuseTabRouteParamMatchMode, ReuseTitle } from './reuse-tab.interfaces';
...
export class ReuseTabService implements OnDestroy {
  ...
  // 滚动条容器
  private keepingScrollContainer: Element;
  // tslint:disable-next-line:variable-name
